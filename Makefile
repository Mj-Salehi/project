...
# Project:  t1\t1.pro
# Template: app
# Command: C:\Qt\Qt5.8.0\5.8\mingw53_32\bin\qmake.exe -o Makefile t1\t1.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: t1/t1.pro C:/Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.8.0/5.8/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile t1\t1.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
